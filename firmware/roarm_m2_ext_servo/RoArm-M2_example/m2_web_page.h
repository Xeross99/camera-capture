            ...
            <section>
                ...
                <div>
                    ...
                    <div style="margin-bottom: 20px;">
                        <label>AP_SSID:</label>
                        <input id="ap_ssid" value="RoArm-M2" style="width:158px; margin: 0 12px; padding:6px; border-radius:6px; border:1px solid #555; background:#f1f2f6; color:#2f3542;" />
                        <label>AP_PWD:</label>
    ...
    var sock = new WebSocket("ws://" + window.location.host + "/ws");
                   ...
                   console.log("jsonRecv", jsonResponse);
                    if (jsonResponse.T == 50) 
                     ...
                     else if (jsonResponse.T == -15)
                     {
                      ...
                      document.getElementById("coordCtrl-t4").innerHTML = Number(jsonResponse.t || 0).toFixed(2);
        ...
        function cmdSend(inputT, inputA, inputB) {
          if (!isOvertemperature&&!isOvercurrent&&!isOvervoltage)
          {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "js?json=" + encoded + "&_t=" + Date.now(), true);
            xhr.send();
