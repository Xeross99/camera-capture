...
- **Sesja** — live view z siatką kadrowania i ramką kadru 1:1 (badge'y klikane), pulsujący badge LIVE (prawy górny róg, tylko gdy preview ON + aparat połączony), badge „TŁO A–B OK / · celuj w 230–254" (percentyle 10/90 z pasków brzegowych klatki; liczby są pokazywane wprost, bo samo „HISTOGRAM !" nie mówiło, co jest nie tak);
