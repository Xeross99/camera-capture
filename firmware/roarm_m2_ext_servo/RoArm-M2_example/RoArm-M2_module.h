...
// void get_torque(byte servoID)
// {
//   float Current=st.ReadCurrent(servoID);
//   servoFeedback[servoID - 11].torque = Current*6.5/1000*11;
...
void Move_to_location()
{
  ...
  waitMove2Goal(SHOULDER_DRIVING_SERVO_ID, ARM_SERVO_MIDDLE_POS-1024, 120);
...
void RoArmM2_infoFeedback() {
  ...
  jsonInfoHttp["torswitchH"] = servoFeedback[GRIPPER_SERVO_ID - 11].Torquestatus;
  jsonInfoHttp["torque1"] = servoFeedback[BASE_SERVO_ID - 11].torque;
   jsonInfoHttp["torque2"] = servoFeedback[SHOULDER_DRIVING_SERVO_ID - 11].torque;
  jsonInfoHttp["torque3"] = servoFeedback[SHOULDER_DRIVING_SERVO_ID - 11].torque;
  jsonInfoHttp["torque4"] = servoFeedback[ELBOW_SERVO_ID - 11].torque;
  jsonInfoHttp["torque5"] = servoFeedback[GRIPPER_SERVO_ID - 11].torque;
  jsonInfoHttp["Stalltor"] = Stall_flag;
  jsonInfoHttp["Stalltep"] = Temp_flag;
  jsonInfoHttp["Stallvol"] = Voltage_flag;
...
// Coordinate Ctrl: input the coordinate point of the goal posiytion to compute
...
void Stall_detection()
{
  ...
  //   get_torque(i);
  // }
  if(servoFeedback[0].current<Protective_current&&servoFeedback[1].current<Protective_current&&servoFeedback[2].current<Protective_current&&servoFeedback[3].current<Protective_current&&servoFeedback[4].current<Protective_current)
  {
    Stall_flag=false;
  }else
  {
