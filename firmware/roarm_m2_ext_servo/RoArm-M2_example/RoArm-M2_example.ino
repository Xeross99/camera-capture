...
// extra bus servo beyond IDs 11-15 (camera tilt for Camera Capture).
#include "ext_servo.h"
...
void setup() {
 ...
 // Stall_detection();
  ...
  missionPlay("boot", 1);
  //RoArmM2_elbowTorqueCtrl(800);
  //RoArmM2_shoulderTorqueCtrl(800);
