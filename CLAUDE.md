...
- **camera** — `CameraSession` + pętla preview z throttlingiem do `preview_fps`; komendy przez `_cam_q` (shoot / set_camera); auto-reconnect co 5 s gdy init się nie uda lub podgląd padnie (np. inna aplikacja trzyma aparat).
